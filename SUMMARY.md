...
* [Starting a local Kafka cluster in seconds](kafka-cluster-connection/starting-a-local-kafka-cluster-in-seconds.md)
...
* [How to Consume data?](features/consuming-data/README.md)
  ...
  * [Custom deserializers](features/consuming-data/custom-deserializers/README.md)
    * [RedHat Apicurio Schema Registry](features/consuming-data/custom-deserializers/redhat-apicurio-schema-registry.md)
    * [AWS Glue Schema Registry](features/consuming-data/custom-deserializers/aws-glue-schema-registry.md)
